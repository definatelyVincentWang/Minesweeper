...
String[] BRC_ids = new String[] {"restart","size","mines","difficulty"};
String[] BRC_values = new String[] {"0","16","16","C"};
...
+ "[\"MONITOR\",\"brc_6\",\"pbh\"],\n"
+ "[\"MONITOR\",\"brc_7\",\"pbi\"],\n"
+ "[\"RANGE\",\"brc_8\",\"size\",\"brc_9\"],\n"
+ "[\"RANGE\",\"brc_10\",\"mines\",\"brc_11\"],\n"
+ "[\"DROPDOWN\",\"brc_12\",\"difficulty\"]];\n"
+ "\n"
+ "Monitor = true;\n"
+ "\n"
+ "function Sendall() {\n"
...
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><table><tr><td class=\"auto-style1\">mines remaining <label id=\"brc_2\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">stopwatch <label id=\"brc_3\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">Easy Personal Best <label id=\"brc_4\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">Medium Personal Best <label id=\"brc_5\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">Hard Personal Best <label id=\"brc_6\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">Insane Personal Best <label id=\"brc_7\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">5  \n"
+ "    <input type=\"range\" id=\"brc_8\" name=\"brc_8\" min=\"5\" max=\"30\" value=\"16\" step=\"1\"\n"
+ "  oninput=\"ShowRange('brc_8','brc_9','size');\" />  30<br/>\n"
+ "  number of tiles in width: <label id=\"brc_9\"></label>\n"
+ "  </td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">5  \n"
+ "    <input type=\"range\" id=\"brc_10\" name=\"brc_10\" min=\"5\" max=\"50\" value=\"16\" step=\"1\"\n"
+ "  oninput=\"ShowRange('brc_10','brc_11','mines');\" />  50<br/>\n"
+ "  number of mines: <label id=\"brc_11\"></label>\n"
+ "  </td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">Difficulty Selection:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_12\" id=\"brc_12\" onchange=\"SendNameValue('difficulty='+document.brc.brc_12.value);\">\n"
