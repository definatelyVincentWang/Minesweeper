...
String[] BRC_ids = new String[] {"restart","slow","size","mines","difficulty","mineType"};
String[] BRC_values = new String[] {"0","false","16","16","C","Mine"};

String[] BRC_Monitors = new String[] {"flags","time","pbe","pbm","pbh","pbi"};
String[] BRC_MonitorValues = new String[] {"N/A","N/A","N/A","N/A","N/A","N/A"};
...
void brcInit() {
  ...
  println("BRCFactory version 0.93");
...
+ "*/\n"
+ "\n"
+ "const Controls=[[\"BUTTON\",\"brc_1\",\"restart\"],\n"
+ "[\"CHECKBOX\",\"brc_2\",\"slow\"],\n"
+ "[\"MONITOR\",\"brc_3\",\"flags\"],\n"
+ "[\"MONITOR\",\"brc_4\",\"time\"],\n"
+ "[\"MONITOR\",\"brc_5\",\"pbe\"],\n"
...
+ "[\"MONITOR\",\"brc_7\",\"pbh\"],\n"
+ "[\"MONITOR\",\"brc_8\",\"pbi\"],\n"
+ "[\"RANGE\",\"brc_9\",\"size\",\"brc_10\"],\n"
+ "[\"RANGE\",\"brc_11\",\"mines\",\"brc_12\"],\n"
+ "[\"DROPDOWN\",\"brc_13\",\"difficulty\"],\n"
+ "[\"DROPDOWN\",\"brc_14\",\"mineType\"]];\n"
+ "\n"
+ "Monitor = true;\n"
+ "\n"
+ "function Sendall() {\n"
...
+ "\n"
+ "<table><tr><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"restart\" onClick=\"SendNameValue('restart='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><table ><tr><td class=\"auto-style1\">\n"
+ "Lower Graphics:  <input name=\"brc_2\" type=\"checkbox\"  id=\"brc_2\" onclick=\"SendCheckbox('brc_2','slow');\"/> \n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">mines remaining <label id=\"brc_3\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">stopwatch <label id=\"brc_4\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">Easy Personal Best <label id=\"brc_5\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">Medium Personal Best <label id=\"brc_6\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">Hard Personal Best <label id=\"brc_7\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">Insane Personal Best <label id=\"brc_8\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">5  \n"
+ "    <input type=\"range\" id=\"brc_9\" name=\"brc_9\" min=\"5\" max=\"30\" value=\"16\" step=\"1\"\n"
+ "  oninput=\"ShowRange('brc_9','brc_10','size');\" />  30<br/>\n"
+ "  number of tiles in width: <label id=\"brc_10\"></label>\n"
+ "  </td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">5  \n"
+ "    <input type=\"range\" id=\"brc_11\" name=\"brc_11\" min=\"5\" max=\"50\" value=\"16\" step=\"1\"\n"
+ "  oninput=\"ShowRange('brc_11','brc_12','mines');\" />  50<br/>\n"
+ "  number of mines: <label id=\"brc_12\"></label>\n"
+ "  </td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">Difficulty Selection:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_13\" id=\"brc_13\" onchange=\"SendNameValue('difficulty='+document.brc.brc_13.value);\">\n"
+ "<option  value=\"E\">easy</option>\n"
+ "<option  value=\"M\">medium</option>\n"
+ "<option  value=\"H\">hard</option>\n"
+ "<option  value=\"I\">insane</option>\n"
+ "<option selected=\"selected\" value=\"C\">custom</option>\n"
+ "</select></td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">Mine Type:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_14\" id=\"brc_14\" onchange=\"SendNameValue('mineType='+document.brc.brc_14.value);\">\n"
